...
function UserHome() {
  const api = `${routePath}api/getallproducts`
  ...
  return (
    <>
      ...
      <div className="container-fluid mt-5">
        <div className="row  shadow services p-2">
      ...
      <section className="projects bg-white mx-4 my-5 " id="">
        <div className='text-center'>
          <h5 className='my-3'>VIEW ALL SHOPS</h5>
          <h1 className='mb-5'>Dukan24h Shop</h1>
        </div>
        {/* list Crousel */}
      ...
      <section className="projects bg-white my-5 " id="project__section">
        <div className="container">
          <div className='text-center'>
            <h5 style={{ textTransform: "uppercase" }} className='my-3'>Latest</h5>
            <h1 style={{ textTransform: "uppercase" }} className='mb-5'>products</h1>
          </div>
          <div className="row row-gap-3 mx-sm-auto">
            {
              products.slice(0,20).map((val, key) => (
      ...
      <section className="projects bg-white my-5 " id="project__section">
        <div className="container">
          <div className='text-center'>
            <h5 style={{ textTransform: "uppercase" }} className='my-3'>featured</h5>
            <h1 style={{ textTransform: "uppercase" }} className='mb-5'>products</h1>
          </div>
          <div className="row row-gap-3 mx-sm-auto">
            {
